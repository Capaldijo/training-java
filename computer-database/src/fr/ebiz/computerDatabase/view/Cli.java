...
public class Cli {
	...
	/*
	 * Top menu in which we choose between list companies list computers, create
	 * a computer or quit and return the user's choice
	 */
	...
	/*
	 * only print message when called by other classes because only View is
